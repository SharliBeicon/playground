...
var ASM_CONSTS = {
  134952: () => { if (document.fullscreenElement) return 1; },  
 134998: () => { return document.getElementById('canvas').width; },  
 135050: () => { return parseInt(document.getElementById('canvas').style.width); },  
 135118: () => { document.exitFullscreen(); },  
 135145: () => { setTimeout(function() { Module.requestFullscreen(false, false); }, 100); },  
 135218: () => { if (document.fullscreenElement) return 1; },  
 135264: () => { return document.getElementById('canvas').width; },  
 135316: () => { return screen.width; },  
 135341: () => { document.exitFullscreen(); },  
 135368: () => { setTimeout(function() { Module.requestFullscreen(false, true); setTimeout(function() { canvas.style.width="unset"; }, 100); }, 100); },  
 135501: () => { return window.innerWidth; },  
 135527: () => { return window.innerHeight; },  
 135554: () => { if (document.fullscreenElement) return 1; },  
 135600: () => { return document.getElementById('canvas').width; },  
 135652: () => { return parseInt(document.getElementById('canvas').style.width); },  
 135720: () => { if (document.fullscreenElement) return 1; },  
 135766: () => { return document.getElementById('canvas').width; },  
 135818: () => { return screen.width; },  
 135843: () => { return window.innerWidth; },  
 135869: () => { return window.innerHeight; },  
 135896: () => { if (document.fullscreenElement) return 1; },  
 135942: () => { return document.getElementById('canvas').width; },  
 135994: () => { return screen.width; },  
 136019: () => { document.exitFullscreen(); },  
 136046: () => { if (document.fullscreenElement) return 1; },  
 136092: () => { return document.getElementById('canvas').width; },  
 136144: () => { return parseInt(document.getElementById('canvas').style.width); },  
 136212: () => { document.exitFullscreen(); },  
 136239: ($0) => { document.getElementById('canvas').style.opacity = $0; },  
 136297: () => { return screen.width; },  
 136322: () => { return screen.height; },  
 136348: () => { return window.screenX; },  
 136375: () => { return window.screenY; },  
 136402: ($0) => { navigator.clipboard.writeText(UTF8ToString($0)); },  
 136455: ($0) => { document.getElementById("canvas").style.cursor = UTF8ToString($0); },  
 136526: () => { document.getElementById('canvas').style.cursor = 'none'; },  
 136583: ($0, $1, $2, $3) => { try { navigator.getGamepads()[$0].vibrationActuator.playEffect('dual-rumble', { startDelay: 0, duration: $3, weakMagnitude: $1, strongMagnitude: $2 }); } catch (e) { try { navigator.getGamepads()[$0].hapticActuators[0].pulse($2, $3); } catch (e) { } } },  
 136839: ($0) => { document.getElementById('canvas').style.cursor = UTF8ToString($0); },  
 136910: () => { if (document.fullscreenElement) return 1; },  
 136956: () => { return window.innerWidth; },  
 136982: () => { return window.innerHeight; },  
 137009: () => { if (document.pointerLockElement) return 1; }
};
var wasmImports = {
  /** @export */
